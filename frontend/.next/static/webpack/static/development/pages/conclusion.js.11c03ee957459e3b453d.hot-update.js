...
function (_Component) {
  ...
  function ListMenu(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_9__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_7__["default"])(_this), "getArrayofLink", function (data) {
      ...
      var arr = Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_2__["default"])(newArray).sort(_this.dynamicSort("-chapitre")); // const enumeration = ["Comprendre", "Changer", "Agir"]
      // for(let i in enumeration) {
      //     for(const item of arr) {
      //         if(enumeration[i] === item.chapitre) {
      //             if(newArrayd.length === 0) {
      //                 newArrayd.push(item)
      //             } else {
      //                 if( item.ordre > newArra)
      //             }
      //         }
      //     }
      // }
...
//# sourceMappingURL=conclusion.js.11c03ee957459e3b453d.hot-update.js.map